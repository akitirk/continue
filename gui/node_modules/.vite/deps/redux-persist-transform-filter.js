import {
  es_exports,
  init_es
} from "./chunk-MSP2E7YR.js";
import "./chunk-XPLJT6UH.js";
import {
  __commonJS,
  __toCommonJS
...
var require_dist = __commonJS({
  "node_modules/redux-persist-transform-filter/dist/index.js"(exports) {
    ...
    function createFilter(reducerName, inboundPaths, outboundPaths) {
      var transformType = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "whitelist";
    ...
    function filterObject(_ref, state) {
      var path = _ref.path, _ref$filterFunction = _ref.filterFunction, filterFunction = _ref$filterFunction === void 0 ? function() {
        return true;
      } : _ref$filterFunction;
    ...
    function persistFilter(state) {
      ...
      var transformType = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "whitelist";
      var subset = {};
          ...
          if ((typeof path === "undefined" ? "undefined" : _typeof(path)) === "object" && !(path instanceof Array)) {
            ...
            if (!(0, _isEmpty2.default)(value)) {
              if (value instanceof Array) {
                ...
                (0, _forIn2.default)(value, function(value2, key) {
...
//# sourceMappingURL=redux-persist-transform-filter.js.map
